...
function checkIfPlayerWon() {
  ...
  if (player.inventory.diamon >= diamondToCollect ||
...
function paintTerrainTiles(node, index) {
  ...
  let noiseAmount = density * y; // sets the terrain to paint (starts on the top)
  let yLevel = HEIGHT - y; // reverses the Y to paint terrain on the bottom
